                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <span class="text-dark fw-bolder fs-6">Akhmad Khasan Abdullah</span>
                                                        <span class="text-muted fw-bold text-muted d-block fs-7">201910370311032</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="fw-bold d-block fs-7">akhmadkhasan68@webmail.umm.ac.id</span>
                                            </td>
                                            <td>
                                                <span class="fw-bold d-block fs-7">083852413038</span>
                                            </td>
                                            <td>
