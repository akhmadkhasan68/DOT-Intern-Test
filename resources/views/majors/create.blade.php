...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <!--end::Separator-->
            <!--begin::Description-->
            <span class="text-muted fs-7 fw-bold mt-2">Buat Jurusan Baru</span>
            <!--end::Description--></h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
...
<div class="post d-flex flex-column-fluid" id="kt_post">
    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form autocomplete="off" onsubmit="event.preventDefault(); submitForm(this)" action="{{ route('majors.store') }}" method="post">
                        <div class="card-body">
                            @csrf
                            <div class="form-group mb-3">
                                <label class="form-control-label required" for="name">Nama</label>
                                <input type="text" class="form-control form-control-solid" name="name" placeholder="Masukkan Nama Jurusan ...">
                            </div>
                        </div>
